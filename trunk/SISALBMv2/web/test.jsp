<%-- 
    JSP Base, se toma la plantilla de la aplicaciÛn de directorio del web interno, no se utiliza dentro de la app
--%>
                ...
                <div class="column workarea">
                    <div class="module">
                        ...
                        <div class="info">
                            ...
                            <br />
                            <center>
                                <form action="BusquedaEmpleado.dirtel" method="post" onsubmit="return FrontPage_Form1_Validator(this)" name="FrontPage_Form1">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <a href="javascript:cambia_prin(0);cambia_busqueda()" >
                                                    <img src="../images/close.gif" alt="B˙squeda avanzada" align="middle" border="0" name="IMG_0" />
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
